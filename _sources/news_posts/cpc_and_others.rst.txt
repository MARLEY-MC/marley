...
New MARLEY-based simulations of :math:`^{8}\mathrm{B}` solar neutrino events in the `DEAP-3600
...
:math:`\nu_e` events in a 7.20 tonne-year exposure assuming 100% acceptance. If
...
input files have been released yet for :math:`^{208}\mathrm{Pb}` (or any of the other Pb
