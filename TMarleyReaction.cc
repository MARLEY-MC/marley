...
// (a + b -> c + d)
void TMarleyReaction::two_two_scatter(double Ea, double& s, double& Ec_cm,
...
TMarleyEvent TMarleyReaction::make_event_object(double Ea,
  ...
  double Ec_cm, double Ed_cm, double E_level)
{
  ...
  TMarleyParticle projectile(pid_a, Ea, 0, 0, pa, ma);
