...
marley::ElectronReaction::ElectronReaction(size_t Z) {
...
bool marley::ElectronReaction::determine_coupling_constants(int particle_id_a) {
...
double marley::ElectronReaction::total_xs(int particle_id_a, double Ea) {
...
double marley::ElectronReaction::diff_xs_cm_for_sampling(double s,
...
double marley::ElectronReaction::sample_cos_theta_c_cm(double s,
  marley::Generator& gen)
{
  ...
  std::function<double(double)> diff_xs = std::bind(
    &marley::ElectronReaction::diff_xs_cm_for_sampling, this, s,
    std::placeholders::_1);
...
marley::Event marley::ElectronReaction::create_event(int particle_id_a, double Ea,
  marley::Generator& gen)
{
  // Determine the coupling constants g1 and g2 based on the projectile
  bool projectile_recognized = determine_coupling_constants(particle_id_a);
