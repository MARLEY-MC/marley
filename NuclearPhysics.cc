...
void marley::NuclearPhysics::hf_test(int Zi, int Ai,
  ...
  marley::StructureDatabase& db, marley::Generator& gen)
{
  ...
  for (size_t i = 0; i < widths.size(); ++i) {
    ...
    const marley::Level* lev = levels.at(i);
    const marley::Fragment* fr = frags.at(i);
    ...
    marley::Particle first_product = marley::Particle(pid_frag, m_frag);
    marley::Particle second_product = marley::Particle(pid_final, mfgs + Exf);
...
void marley::NuclearPhysics::hf_test2(int Zi, int Ai,
  const marley::Particle& initial_particle, double Ex,
  int twoJ, marley::Parity Pi,
  marley::StructureDatabase& db, marley::Generator& gen,
...
void marley::NuclearPhysics::hf_test3(int Zi, int Ai,
...
/***
marley::HFTable marley::NuclearPhysics::create_hf_table(int Zi, int Ai,
  const marley::Particle& initial_particle,
  double Ex, int twoJ, marley::Parity Pi, marley::StructureDatabase& db,
  marley::Generator& gen)
{
  marley::HFTable hftable;
