...
double marley::NewFormFactors::F1p( double Q2 ) const {
...
double marley::NewFormFactors::F1n( double Q2 ) const {
  double tau = sachs_ff_->tau( Q2 );
...
double marley::NewFormFactors::F2p( double Q2 ) const {
  double tau = sachs_ff_->tau( Q2 );
  double GEp = sachs_ff_->GEp( Q2 );
  double GMp = sachs_ff_->GMp( Q2 );
...
double marley::NewFormFactors::F2n( double Q2 ) const {
  double tau = sachs_ff_->tau( Q2 );
  double GEn = sachs_ff_->GEn( Q2 );
  double GMn = sachs_ff_->GMn( Q2 );
