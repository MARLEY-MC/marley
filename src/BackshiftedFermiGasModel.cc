...
double marley::BackshiftedFermiGasModel::level_density(int Z, int A, double Ex) {
  double dummy;
  return level_density(Z, A, Ex, dummy);
}

double marley::BackshiftedFermiGasModel::level_density(int Z, int A, double Ex, int two_J) {
  double sigma;
...
double marley::BackshiftedFermiGasModel::level_density(int Z, int A, double Ex, double& sigma) {
  int N = A - Z;
  ...
  double delta_W = marley::MassTable::get_mass_excess(Z, A)
    - marley::MassTable::liquid_drop_model_mass_excess(Z, A);
  // Energy shift
  ...
  double Sn = marley::MassTable::get_fragment_separation_energy(Z, A,
